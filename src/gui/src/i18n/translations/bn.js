...
const bn = {
  ...
  dictionary: {
    ...
    remove: "অপসারণ",
    'account.avatar.removeButton': 'অপসারণ',
    'account.avatar.removeConfirm': "আপনি কি আপনার প্রোফাইল ছবি মুছে ফেলতে চান? এর ফলে আপনার ডিফল্ট অ্যাভাটার ফিরে আসবে।",
    'account.avatar.removedToast': 'প্রোফাইল ছবি মুছে ফেলা হয়েছে।',
    'confirm_remove_profile_picture': "আপনি কি আপনার প্রোফাইল ছবি মুছে ফেলতে চান? এর ফলে আপনার ডিফল্ট অ্যাভাটার ফিরে আসবে।",
    'confirm_remove_profile_picture_title': 'প্রোফাইল ছবি মুছুন?',
