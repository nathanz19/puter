...
const hy = {
    ...
    dictionary: {
        ...
        // hy (Armenian / Հայերեն)
        remove: "Ջնջել",
        'account.avatar.removeButton': 'Ջնջել',
        'account.avatar.removeConfirm': "Դուք համոզվա՞ծ եք, որ ցանկանում եք ջնջել ձեր պրոֆիլի նկարը։ Դա կվերականգնի ձեր ստանդարտ ավատարան։",
        'account.avatar.removedToast': 'Պրոֆիլի նկարն ջնջվել է։',
        'confirm_remove_profile_picture': "Դուք համոզվա՞ծ եք, որ ցանկանում եք ջնջել ձեր պրոֆիլի նկարը։ Դա կվերականգնի ձեր ստանդարտ ավատարան։",
        'confirm_remove_profile_picture_title': 'Ջնջել պրոֆիլի նկարը?',
