...
const ml = {
    ...
    dictionary: {
        ...
        'account.avatar.removeButton': 'നീക്കംചെയ്യുക',
        'account.avatar.removeConfirm': "പ്രൊഫൈൽ ചിത്രം നീക്കം ചെയ്യാൻ നിങ്ങൾക്ക് pasti ആണോ? ഇത് നിങ്ങളുടെ ഡീഫോൾട്ട് അവതാർ വീണ്ടെടുക്കും.",
        'account.avatar.removedToast': 'പ്രൊഫൈൽ ചിത്രം നീക്കംചെയ്തു.',
        'confirm_remove_profile_picture': "പ്രൊഫൈൽ ചിത്രം നീക്കം ചെയ്യാൻ നിങ്ങൾക്ക് pasti ആണോ? ഇത് നിങ്ങളുടെ ഡീഫോൾട്ട് അവതാർ വീണ്ടെടുക്കും.",
        'confirm_remove_profile_picture_title': 'പ്രൊഫൈൽ ചിത്രം നീക്കംചെയ്യൽ?',
