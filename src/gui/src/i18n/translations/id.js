...
const id = {
  ...
  dictionary: {
    ...
    remove: "Hapus",
    'account.avatar.removeButton': 'Hapus',
    'account.avatar.removeConfirm': "Apakah Anda yakin ingin menghapus foto profil Anda? Ini akan mengembalikan avatar default Anda.",
    'account.avatar.removedToast': 'Foto profil dihapus.',
    'confirm_remove_profile_picture': "Apakah Anda yakin ingin menghapus foto profil Anda? Ini akan mengembalikan avatar default Anda.",
    'confirm_remove_profile_picture_title': 'Hapus foto profil?',
