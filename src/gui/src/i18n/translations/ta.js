...
const ta = {
  ...
  dictionary: {
    ...
    // ta (Tamil / தமிழ்)
    remove: "அகற்று",
    'account.avatar.removeButton': 'அகற்று',
    'account.avatar.removeConfirm': "உங்கள் சுயவிவரப் பிம்பத்தை அகற்ற வேண்டுமா? இது உங்கள் இயல்புநிலை அவதாரைப் பழகும்.",
    'account.avatar.removedToast': 'சுயவிவரப் பிம்பு அகற்றப்பட்டது.',
    'confirm_remove_profile_picture': "உங்கள் சுயவிவரப் பிம்பத்தை அகற்ற வேண்டுமா? இது உங்கள் இயல்புநிலை அவதாரைப் பழகும்.",
    'confirm_remove_profile_picture_title': 'சுயவிவரப் பிம்பம் அகற்ற வேண்டுமா?',
