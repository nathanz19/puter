...
const ku = {
  ...
  dictionary: {
    ...
    remove: "سڕینەوە",
    'account.avatar.removeButton': 'سڕینەوە',
    'account.avatar.removeConfirm': "دڵنیایت دەتەوێت وێنەی پڕۆفایلەکەت بسڕیتەوە؟ ئەمە وێنەی بنەڕەتییەکەت دەگەڕێنێتەوە.",
    'account.avatar.removedToast': 'وێنەی پڕۆفایل سڕایەوە.',
    'confirm_remove_profile_picture': "دڵنیایت دەتەوێت وێنەی پڕۆفایلەکەت بسڕیتەوە؟ ئەمە وێنەی بنەڕەتییەکەت دەگەڕێنێتەوە.",
    'confirm_remove_profile_picture_title': 'سڕینەوەی وێنەی پڕۆفایل؟',
